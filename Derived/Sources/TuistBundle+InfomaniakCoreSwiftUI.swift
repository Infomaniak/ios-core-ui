...
/// Since InfomaniakCoreSwiftUI is a staticFramework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "InfomaniakCoreUI_InfomaniakCoreSwiftUI"
    var candidates = [
    ...
    fatalError("unable to find bundle named InfomaniakCoreUI_InfomaniakCoreSwiftUI")
}()
